...
public:
    ...
    class DataCharacteristic {
      public:
        ...
        Type type = DataCharacteristic::Type::NONE;
    };

    class DecodedImageCharacteristic : public DataCharacteristic {
      public:
        DecodedImageCharacteristic ();
        int width;
        int height;
        int component;
    };
     ...
     */
    void addResourceData(const char* uri, BufferDescriptor&& buffer, std::shared_ptr<ResourceLoader::DataCharacteristic> dataCharacteristic = nullptr);
     ...
     */
    bool loadResources(FilamentAsset* asset, bool forceLoadCgltfBufferFromExternalCache = false);
...
private:
    bool loadResources(FFilamentAsset* asset, bool async, bool forceLoadCgltfBufferFromExternalCache = false);
    void loadVerticesData(gltfio::MorphBaseData& morphBaseData);
