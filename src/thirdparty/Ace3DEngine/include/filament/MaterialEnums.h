...
enum class RefractionMode : uint8_t {
    ...
    CAMERA          = 3, //!< refracted rays go to camera texture
};
...
enum class Property : uint8_t {
    ...
    HAIR_ANISOTROPY,         //!< float,  lit shading models only, except subsurface and cloth
    BENT_NORMAL,             //!< float3, all shading models only, except unlit
    CAMERA_MAP,              //!< float3, all shading models
