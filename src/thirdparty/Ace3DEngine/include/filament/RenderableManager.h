...
public:
    ...
    void setBoundingBox(Instance instance, size_t primitiveIndex, const Box& aabb) noexcept;
    ...
    /**
    * Add the target material instance to material array.
    *
    */
    void addMaterialInstance(Instance instance, size_t primitiveIndex, MaterialInstance const* materialInstance) noexcept;

    /**
    * Remove the target material instance from material array.
    *
    */
    void removeMaterialInstanceAt(Instance instance, size_t primitiveIndex, uint16_t passIndex) noexcept;

    void removeAllMaterialInstances(Instance instance, size_t primitiveIndex) noexcept;

    /**
     * Changes the target material member in material array of the given primitive.
     *
     */
    void setMaterialInstanceAt(Instance instance,
                               size_t primitiveIndex, MaterialInstance const* materialInstance, uint16_t passIndex) noexcept;

    /**
     * Retrieves the target material member from the material array that is bound to the given primitive.
     */
    MaterialInstance* getMaterialInstanceAt(Instance instance, size_t primitiveIndex, uint16_t passIndex) const noexcept;


    uint16_t getMaterialInstancesCount(Instance instance, size_t primitiveIndex);
    /**
