...
public:
    ...
    static const std::unordered_map<InternalFormat, Format> FORMAT_MAP;
    static const std::unordered_map<InternalFormat, Type> TYPE_MAP;
     ...
     */
    int getId(Engine& engine);

    void setId(Engine& engine, intptr_t id);
