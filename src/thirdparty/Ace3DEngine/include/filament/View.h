...
struct ClearOptions {
     ...
     */
    bool discard = true;
    //! Depth value to clear the depth buffer with. Always clear depth.
    double clearDepth = 1.0;
    //! Stencil value to clear the stencil buffer with. Always clear stencil.
...
public:
    ...
    struct BloomOptions {
        ...
        LinearColor bloomColor{1.0f};           //!< color applied to the bloom effect.
        float thresholdValue = 1.0f;            //!< filters out pixels under this level of brightness         
    };
    ...
    */
    ...
    /**
     * Set ClearOptions which are used at the beginning of a view to clear rendertarget.
     * if call setClearOptions will setClearOptionsEnabled(true), will discard Renderer clear options.
    */
    void setClearOptions(const ClearOptions& options);

    /**
     * Enables or disables view clear options. Disabled by default.
     * @param enabled true: use view clear options
     */
    void setClearOptionsEnabled(bool enabled) noexcept;
    ...
    /**
     * Enables or disables color grading. Enabled by default.
     * @param enabled true enables post processing, false disables it.
     */
    void setColorGradingEnabled(bool enabled) noexcept;

    //! Returns true if color grading is enabled. See setColorGradingEnabled() for more info.
    bool isColorGradingEnabled() const noexcept;
