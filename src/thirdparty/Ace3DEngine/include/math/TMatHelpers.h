...
namespace filament {
    namespace  math {
        namespace  details {
            ...
            // 这几个函数在ANDROID aarch64 上层实现了
            extern filament::math::details::TMat44<float>
            ...
            namespace matrix {
                ...
                template<typename MATRIX_R, typename MATRIX_A, typename MATRIX_B,
                        ...
                        typename = std::enable_if_t<
                                ...
                                MATRIX_R::NUM_ROWS == MATRIX_A::NUM_ROWS, int>,
                        typename = std::enable_if_t<
                                !(std::is_same<filament::math::details::TMat44<float>, MATRIX_A>::value &&
                                  std::is_same<filament::math::details::TMat44<float>, MATRIX_B>::value)>,
                        typename = std::enable_if_t<
                                MATRIX_A::NUM_COLS == MATRIX_B::NUM_ROWS &&
                                MATRIX_R::NUM_COLS == MATRIX_B::NUM_COLS &&
                                (MATRIX_A::NUM_COLS == 4 && MATRIX_A::NUM_ROWS == 4 && MATRIX_B::NUM_COLS == 4 && MATRIX_B::NUM_ROWS == 4) &&
                ...
                template<typename MATRIX_R, typename MATRIX_A, typename MATRIX_B,
                        typename = std::enable_if_t<
                                ...
                                MATRIX_R::NUM_ROWS == MATRIX_A::NUM_ROWS, int>,
                        typename = std::enable_if_t<std::is_same<filament::math::details::TMat44<float>, MATRIX_A>::value>,
                        typename = std::enable_if_t<std::is_same<filament::math::details::TMat44<float>, MATRIX_B>::value>,
                        typename = std::enable_if_t<
                                MATRIX_A::NUM_COLS == MATRIX_B::NUM_ROWS &&
                                MATRIX_R::NUM_COLS == MATRIX_B::NUM_COLS &&
                                (MATRIX_A::NUM_COLS == 4 && MATRIX_A::NUM_ROWS == 4 && MATRIX_B::NUM_COLS == 4 && MATRIX_B::NUM_ROWS == 4) &&
                ...
                constexpr MATRIX_R MATH_PURE multiply(MATRIX_A lhs, MATRIX_B rhs) {
                    ...
                    //  res : C columns, R rows
#if defined(__aarch64__)
                    return filament::math::details::matMultiply4x4_simd(lhs, rhs);
#else
                    MATRIX_R res{};
                    for (size_t col = 0; col < MATRIX_R::NUM_COLS; ++col) {
                        res[col] = lhs * rhs[col];
