...
#include <arm_neon.h>
inline void matrix_multiply_4x4_neon(float32_t *A, float32_t *B, float32_t *C) {
    ...
    BB0 = vld1q_f32(B);
    CC0 = vfmaq_laneq_f32(CC0, AA0, BB0, 0);
    CC0 = vfmaq_laneq_f32(CC0, AA1, BB0, 1);
    CC0 = vfmaq_laneq_f32(CC0, AA2, BB0, 2);
    CC0 = vfmaq_laneq_f32(CC0, AA3, BB0, 3);
    vst1q_f32(C, CC0);

    BB1 = vld1q_f32(B+4);
    CC1 = vfmaq_laneq_f32(CC1, AA0, BB1, 0);
    CC1 = vfmaq_laneq_f32(CC1, AA1, BB1, 1);
    CC1 = vfmaq_laneq_f32(CC1, AA2, BB1, 2);
    CC1 = vfmaq_laneq_f32(CC1, AA3, BB1, 3);
    vst1q_f32(C+4, CC1);

    BB2 = vld1q_f32(B+8);
    CC2 = vfmaq_laneq_f32(CC2, AA0, BB2, 0);
    CC2 = vfmaq_laneq_f32(CC2, AA1, BB2, 1);
    CC2 = vfmaq_laneq_f32(CC2, AA2, BB2, 2);
    CC2 = vfmaq_laneq_f32(CC2, AA3, BB2, 3);
    vst1q_f32(C+8, CC2);

    BB3 = vld1q_f32(B+12);
    CC3 = vfmaq_laneq_f32(CC3, AA0, BB3, 0);
    CC3 = vfmaq_laneq_f32(CC3, AA1, BB3, 1);
    CC3 = vfmaq_laneq_f32(CC3, AA2, BB3, 2);
    CC3 = vfmaq_laneq_f32(CC3, AA3, BB3, 3);
    vst1q_f32(C+12, CC3);
}
...
namespace filament {
    namespace math {
        namespace details {
            inline filament::math::details::TMat44<float>
            matMultiply4x4_simd(filament::math::details::TMat44<float> &matrix1,
                                filament::math::details::TMat44<float> &matrix2) {

                filament::math::details::TMat44<float> ret;

                matrix_multiply_4x4_neon(&matrix1[0][0], &matrix2[0][0], &ret[0][0]);
